...
public class login extends Form{
       ...
       // flow.addComponent(l);
        ...
        signIn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                UserForm userForm = new UserForm(username.getText(), (EncodedImage) theme.getImage("user-picture.jpg"), null);
                userForm.show();
            }
        });
        ...
        Button loginWFace = new Button("signin_facebook.png");
        ...
        loginWFace.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                login = fb;
                fb.setCallback(new login.LoginListener(SignIn.LoginListener.FACEBOOK));
        ...
        Button loginWG = new Button("signin_google.png");
        ...
        loginWG.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                login = gc;
                gc.setCallback(new login.LoginListener(SignIn.LoginListener.GOOGLE));
    ...
    public void stop() {
        ...
        d.dispose();
        Form userForm = new UserForm(name, (EncodedImage) theme.getImage("user-picture.jpg"), "https://graph.facebook.com/v2.3/me/picture?access_token=" + token);
        userForm.show();
    }
    ...
    private void showGoogleUser(String token){
        ...
        Form userForm = new UserForm(name, (EncodedImage) theme.getImage("user-picture.jpg"), url);
        userForm.show();
    }
